...
const Footer = () => {
  return (
    <footer className="bg-white text-black py-8 mt-16">
      ...
      <div className="flex items-center justify-center container mx-auto mb-4 mt-14 ml-2">
        <div className="p-1 mr-4 border-[1px] border-solid border-black rounded-full">
          <a href="https://www.instagram.com/" target="_blank" rel="noopener noreferrer" className="border-[1px] border-solid border-black">
